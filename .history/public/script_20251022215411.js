document.addEventListener('DOMContentLoaded', function() {
  ...
  // ⛔ Impede que o botão estilizado envie o form automaticamente
  qrForm.addEventListener('submit', function(e) {
    e.preventDefault(); // evita a validação automática de inputs ocultos
    handleGenerateClick(); // chama a lógica manual de geração e download
  });
