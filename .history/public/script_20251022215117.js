document.addEventListener('DOMContentLoaded', function() {
  ...
  // Impede validação automática de campos invisíveis
  ...
  function showForm(type) {
    // Remove required de todos os campos para evitar erro em inputs invisíveis
  ...
  // Ao clicar no botão, gerar e baixar QR
  ...
  // Corrigida: função que gera e baixa o QR Code
