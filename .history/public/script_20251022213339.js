document.addEventListener('DOMContentLoaded', function() {
  ...
  function updatePreview() {
    ...
    if (data && data.trim() !== '') {
      ...
      // Limpa o container do canvas
    const ctx = qrPreview.getContext('2d');
    ctx.clearRect(0, 0, qrPreview.width, qrPreview.height);

    // Cria um elemento temporário para o QRCode.js gerar o código
    ...
    // Renderiza o QR gerado no canvas principal
    setTimeout(() => {
      ...
      if (img) {
        ...
        // Copia a imagem final para o canvas principal
